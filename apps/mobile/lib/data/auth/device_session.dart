...
class DeviceSession {
  ...
  // `dart:io`'s Platform throws UnsupportedError on web (it has no concept of
  // an OS process). `defaultTargetPlatform`/`kIsWeb` from
  // `flutter/foundation.dart` work identically everywhere Flutter runs.
  String _platform() {
